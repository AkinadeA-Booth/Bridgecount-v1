class UserAuthenticationController < ApplicationController
  ...
  def create_cookie
    ...
    if user != nil
      ...
      if are_they_legit == false
        ...
        redirect_to("/accepted_offers", { :notice => "Signed in successfully." })
      end
    else
  ...
  def create
    ...
    @user.company_admin_true_or_false = params.fetch("query_company_admin_true_or_false", false)
    ...
    if save_status == true
      ...
      redirect_to("/accepted_offers", { :notice => "User account created successfully."})
    else
